...
<body class="bg-slate-50 min-h-screen relative overflow-x-hidden selection:bg-slate-200 selection:text-slate-800">
    ...
    <main class="max-w-4xl mx-auto px-4 py-10 flex flex-col items-center">
        ...
        <div class="text-center mb-8 max-w-2xl animate-fade-up">
            ...
            <p class="text-slate-500 text-lg md:text-xl font-medium leading-relaxed">
                Tell us what you need. We'll handle the thinking.
            </p>
        </div>
        ...
        <div class="w-full glass-card rounded-3xl p-6 md:p-10 mb-12 transform transition-all duration-500 hover:shadow-xl animate-fade-up border-t-4 border-slate-800" style="animation-delay: 0.1s;">
            ...
            <div class="flex gap-8 mb-8 border-b border-slate-200 pb-2">
                ...
                <button onclick="switchTab('chat')" id="tab-chat" class="tab-inactive pb-2 transition-colors hover:text-slate-600">Ask Concierge ✨</button>
            </div>
            ...
            <!-- MODE 2: Ask Concierge (Text Input) -->
        ...
        <div id="loadingState" class="hidden py-12 text-center animate-fade-up">
            ...
            <h3 class="text-slate-800 font-semibold text-lg">Curating options...</h3>
        </div>
    ...
    <script>
        ...
        // 1. EXPANDED INVENTORY (30+ Items)
        const inventory = [
            // DESK & WRITING
            { name: "Parker Vector Pen", price: 450, tags: ["safe", "desk", "classic", "writing"], url: "https://www.amazon.in/s?k=Parker+Vector+Stainless+Steel+CT+Ball+Pen", pitch: "The universal symbol of a professional gift.", bestFor: "Formal settings", imgKeyword: "luxury pen" },
            { name: "Factor Notes Journal", price: 499, tags: ["desk", "creative", "safe", "writing"], url: "https://www.amazon.in/s?k=Factor+Notes+Hardcover+Notebook+A5", pitch: "Premium paper for serious thinkers.", bestFor: "Planners", imgKeyword: "black notebook" },
            { name: "Moleskine Classic", price: 1900, tags: ["desk", "creative", "premium", "writing"], url: "https://www.amazon.in/s?k=Moleskine+Classic+Notebook", pitch: "The legendary notebook used by artists and thinkers.", bestFor: "Creatives", imgKeyword: "moleskine notebook" },
            { name: "Lamy Safari Pen", price: 2400, tags: ["desk", "creative", "premium", "writing"], url: "https://www.amazon.in/s?k=Lamy+Safari+Fountain+Pen", pitch: "German engineering in a pen. Cult classic.", bestFor: "Designers", imgKeyword: "lamy pen" },
            { name: "Vegan Leather Desk Mat", price: 799, tags: ["desk", "setup", "aesthetic"], url: "https://www.amazon.in/s?k=Vegan+Leather+Desk+Mat+Extended", pitch: "Instantly makes a desk look executive.", bestFor: "New setups", imgKeyword: "desk mat" },
            { name: "Bamboo Desk Organizer", price: 850, tags: ["desk", "organized", "eco"], url: "https://www.amazon.in/s?k=Bamboo+Desk+Organizer", pitch: "Sustainable and stylish organization.", bestFor: "Eco-conscious", imgKeyword: "wooden organizer" },

            // TECH & GADGETS
            { name: "Alloy Laptop Stand", price: 699, tags: ["tech", "health", "desk"], url: "https://www.amazon.in/s?k=Portronics+My+Buddy+K+Portable+Laptop+Stand", pitch: "Saves their neck. Folds into a stick.", bestFor: "Laptop users", imgKeyword: "laptop stand" },
            { name: "DailyObjects Tech Kit", price: 1299, tags: ["tech", "travel", "organized"], url: "https://www.amazon.in/s?k=DailyObjects+Tech+Kit+Organizer", pitch: "Fixes the cable mess.", bestFor: "Hybrid workers", imgKeyword: "tech pouch" },
            { name: "SanDisk Dual Drive", price: 899, tags: ["tech", "utility", "budget"], url: "https://www.amazon.in/s?k=SanDisk+Ultra+Dual+Drive+Go+Type-C", pitch: "High utility data transfer.", bestFor: "Tech roles", imgKeyword: "usb drive" },
            { name: "Logitech Pebble Mouse", price: 1400, tags: ["tech", "aesthetic", "productivity"], url: "https://www.amazon.in/s?k=Logitech+Pebble+Mouse", pitch: "Minimalist, silent, and beautiful.", bestFor: "Designers", imgKeyword: "minimalist mouse" },
            { name: "Portronics SoundDrum", price: 1800, tags: ["tech", "music", "fun"], url: "https://www.amazon.in/s?k=Portronics+SoundDrum", pitch: "Great sound in a small package.", bestFor: "Music lovers", imgKeyword: "bluetooth speaker" },
            { name: "Anker PowerCore 10000", price: 2200, tags: ["tech", "travel", "utility"], url: "https://www.amazon.in/s?k=Anker+PowerCore+10000", pitch: "The most reliable power bank.", bestFor: "Travelers", imgKeyword: "power bank" },
            { name: "Cable Organiser Clips", price: 399, tags: ["tech", "budget", "organized"], url: "https://www.amazon.in/s?k=Cable+Clips+Organizer", pitch: "Simple utility for messy desks.", bestFor: "Everyone", imgKeyword: "cable clips" },

            // COFFEE & FOOD
            { name: "Milton Thermosteel", price: 750, tags: ["utility", "travel", "safe", "coffee"], url: "https://www.amazon.in/s?k=Milton+Thermosteel+Flip+Lid+500ml", pitch: "Keeps coffee hot for 4 hours.", bestFor: "Daily hydration", imgKeyword: "steel bottle" },
            { name: "Borosil Glass Lunch Set", price: 950, tags: ["health", "food", "practical"], url: "https://www.amazon.in/s?k=Borosil+Glass+Lunch+Box+Set+of+3", pitch: "Premium glass, microwave safe.", bestFor: "Office lunches", imgKeyword: "glass lunch box" },
            { name: "Vaya Drynk Tumbler", price: 1600, tags: ["coffee", "premium", "travel"], url: "https://www.amazon.in/s?k=Vaya+Drynk", pitch: "The most stylish tumbler on the market.", bestFor: "Coffee snobs", imgKeyword: "coffee tumbler" },
            { name: "French Press", price: 1200, tags: ["coffee", "home", "aesthetic"], url: "https://www.amazon.in/s?k=Instacuppa+French+Press", pitch: "For serious coffee lovers.", bestFor: "Coffee lovers", imgKeyword: "french press" },
            { name: "Electric Lunch Box", price: 1100, tags: ["food", "tech", "utility"], url: "https://www.amazon.in/s?k=Milton+Electric+Lunch+Box", pitch: "Hot food at your desk, no microwave needed.", bestFor: "Desk diners", imgKeyword: "tiffin box" },

            // TRAVEL & CARRY
            { name: "Sleek Laptop Sleeve", price: 999, tags: ["carry", "minimalist", "safe"], url: "https://www.amazon.in/s?k=Vegan+Leather+Laptop+Sleeve+15.6", pitch: "Slim protection.", bestFor: "Commuters", imgKeyword: "laptop sleeve" },
            { name: "EcoRight Canvas Tote", price: 699, tags: ["carry", "casual", "utility", "eco"], url: "https://www.amazon.in/s?k=EcoRight+Canvas+Tote+Bag+Zipper", pitch: "Heavy duty canvas with zipper.", bestFor: "Casual carry", imgKeyword: "canvas tote" },
            { name: "Passport Holder", price: 800, tags: ["travel", "safe", "leather"], url: "https://www.amazon.in/s?k=Premium+Passport+Holder", pitch: "For the frequent flyer.", bestFor: "Travelers", imgKeyword: "passport holder" },
            { name: "Samsonite Tech Backpack", price: 3800, tags: ["travel", "carry", "safe", "premium"], url: "https://www.amazon.in/s?k=Samsonite+Laptop+Backpack", pitch: "Corporate standard. Indestructible.", bestFor: "Senior Managers", imgKeyword: "black backpack" },
            
            // TIME & DECOR
            { name: "Casio Vintage A158W", price: 1695, tags: ["style", "classic", "safe"], url: "https://www.amazon.in/s?k=Casio+Vintage+A158W", pitch: "Respect from CEOs and Hipsters alike.", bestFor: "Style-conscious", imgKeyword: "casio watch" },
            { name: "Magnetic Hourglass", price: 900, tags: ["desk", "decor", "fun"], url: "https://www.amazon.in/s?k=Magnetic+Hourglass", pitch: "Satisfying desk toy for stress relief.", bestFor: "Fidgeters", imgKeyword: "hourglass" },
            { name: "Google Nest Mini", price: 3499, tags: ["tech", "setup", "home"], url: "https://www.amazon.in/s?k=Google+Nest+Mini", pitch: "Smart assistant for the home office.", bestFor: "Tech lovers", imgKeyword: "smart speaker" }
        ];
        ...
        function switchTab(mode) {
            ...
            document.getElementById('tab-chat').className = "tab-inactive pb-2 transition-colors hover:text-slate-600";
        ...
        function getRecommendations(mode) {
            ...
            if (mode === 'filter') {
                ...
                const budgetMin = budgetVal === 10000 ? 3000 : 0;
            ...
            inventory.forEach(item => {
                ...
                if (mode === 'filter') {
                    const budgetVal = parseInt(document.getElementById('budgetInput').value);
                    if (budgetVal === 10000) {
                        if (item.price < 3000) return;
                    } else {
                        if (item.price > budgetMax) return;
                    }
                }

                let score = 0;
                filterTags.forEach(tag => { if (item.tags.includes(tag)) score += 3; });
                if (item.tags.includes("safe")) score += 1; // Safety bump
        ...
        function renderCards() {
            ...
            if (batch.length === 0) {
                if (startIndex === 0) {
                    ...
                    startIndex = 0; // Reset loop
                    renderCards(); // Show first 3 again
                    return;
                }
            } else {
                batch.forEach(item => {
